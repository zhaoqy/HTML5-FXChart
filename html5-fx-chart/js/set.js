...
function firstSet(type) {
    ...
    if (type == 1) {
        ...
        switch ($("se_type2").value) {
            case "mas":
                $("mas_set").style.visibility = "visible";
                break;
            case "emas":
                $("emas_set").style.visibility = "visible";
                break;
            case "tech":
                $("tech_set").style.visibility = "visible";
                break;
            case "cloud":
                $("set1").disabled = true;
                break;
        ...
        switch ($("se_type3").value) {
            case "macd":
                $("macd_set").style.visibility = "visible";
                break;
            case "sto":
                $("sto_set").style.visibility = "visible";
                break;
            case "rsi":
                $("rsi_set").style.visibility = "visible";
                break;
            default:
                break;
        }
