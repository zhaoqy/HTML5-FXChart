	...
	main_draw: function(type_settings, chart_settings, JSONData) {
		...
		if (type_settings.unit == "ask" || type_settings.unit == "bid") {
			...
			switch (type_settings.type1) {
				case "line":
					this.line_draw(type_settings, chart_settings, JSONData);
					break;
				case "cand":
					this.cand_draw(type_settings, chart_settings, JSONData);
					break;
				case "avg":
					this.avg_draw(type_settings, chart_settings, JSONData);
					break;
			}
		}
